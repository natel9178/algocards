...
const SAMPLE_SPEC_REAL = {
  ...
  description:
    "State of the art detection a variety of objects in photos or videos. ", // done
  ...
  intendedUse: {
    // done
    primaryUsecase:
      " The model analyzed in this card detects one or more physical objects within an image, from apparel and animals to tools and vehicles, and returns a box around each object, as well as a label and description for each object.", // done
...
export default function Card({ spec = SAMPLE_SPEC_REAL }: { spec?: Spec }) {
